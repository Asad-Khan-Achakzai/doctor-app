...
const routes = [
    ...
    {
        path: 'patient-signup',
        loadChildren: () => Promise.all(/*! import() | patient-patient-signup-patient-signup-module */[__webpack_require__.e("default~doctor-doctor-signup-doctor-signup-module~patient-patient-signup-patient-signup-module"), __webpack_require__.e("patient-patient-signup-patient-signup-module")]).then(__webpack_require__.bind(null, /*! ./patient/patient-signup/patient-signup.module */ "./src/app/patient/patient-signup/patient-signup.module.ts")).then(m => m.PatientSignupPageModule)
    },
    {
        path: 'patient-dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() | patient-patient-dashboard-patient-dashboard-module */ "patient-patient-dashboard-patient-dashboard-module").then(__webpack_require__.bind(null, /*! ./patient/patient-dashboard/patient-dashboard.module */ "./src/app/patient/patient-dashboard/patient-dashboard.module.ts")).then(m => m.PatientDashboardPageModule)
    },
    {
        path: 'book-appointment',
        loadChildren: () => Promise.all(/*! import() | patient-book-appointment-book-appointment-module */[__webpack_require__.e("common"), __webpack_require__.e("patient-book-appointment-book-appointment-module")]).then(__webpack_require__.bind(null, /*! ./patient/book-appointment/book-appointment.module */ "./src/app/patient/book-appointment/book-appointment.module.ts")).then(m => m.BookAppointmentPageModule)
    },
    {
        path: 'doctor-signup',
        loadChildren: () => Promise.all(/*! import() | doctor-doctor-signup-doctor-signup-module */[__webpack_require__.e("default~doctor-doctor-signup-doctor-signup-module~patient-patient-signup-patient-signup-module"), __webpack_require__.e("common"), __webpack_require__.e("doctor-doctor-signup-doctor-signup-module")]).then(__webpack_require__.bind(null, /*! ./doctor/doctor-signup/doctor-signup.module */ "./src/app/doctor/doctor-signup/doctor-signup.module.ts")).then(m => m.DoctorSignupPageModule)
    },
    {
        path: 'doctor-profile',
        loadChildren: () => __webpack_require__.e(/*! import() | doctor-doctor-profile-doctor-profile-module */ "doctor-doctor-profile-doctor-profile-module").then(__webpack_require__.bind(null, /*! ./doctor/doctor-profile/doctor-profile.module */ "./src/app/doctor/doctor-profile/doctor-profile.module.ts")).then(m => m.DoctorProfilePageModule)
    },
];
...
/* harmony import */ var _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/native-geocoder/ngx */ "./node_modules/@ionic-native/native-geocoder/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! F:\IIUI notes\projects\DoctorApp\src\main.ts */"./src/main.ts");
