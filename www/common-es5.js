(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcAppSdkCustomDoctorServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var DoctorService = /*#__PURE__*/function () {
        ...
        _createClass(DoctorService, [{
          key: "doctorRegister",
          value: function doctorRegister(credentials) {
            console.log(_server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctor/register');
            var url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctors/register';
          ...
          value: function getAllDoctors() {
            ...
            var url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctors/getAllDoctors'; // this.observable = this.http.get(url);
      ...
      DoctorService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], DoctorService);
      /***/
    }
