...
let DoctorService = class DoctorService {
    ...
    doctorRegister(credentials) {
        console.log(_server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctor/register');
        const url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctors/register';
    ...
    getAllDoctors() {
        ...
        const url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/doctors/getAllDoctors';
