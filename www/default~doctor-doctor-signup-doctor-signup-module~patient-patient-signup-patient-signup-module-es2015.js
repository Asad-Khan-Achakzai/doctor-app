...
/* harmony import */ var _server_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../server.config */ "./src/app/sdk/server.config.ts");
...
let PatientServiceService = class PatientServiceService {
    ...
    userRegister(credentials) {
        ...
        const url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/patients/register';
        return this.http.post(url, credentials);
    }
    sendMail(credentials) {
        const url = _server_config__WEBPACK_IMPORTED_MODULE_3__["Path"].getPath() + '/patients/sendMail';
        return this.http.post(url, credentials);
    }
};
...
PatientServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let MapModalComponent = class MapModalComponent {
    constructor(modalCtrl, ngZone, renderer, mapsAPILoader) {
        ...
        return new Promise((resolve, reject) => {
            ...
            script.src =
                'https://maps.googleapis.com/maps/api/js?key=' +
                    _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].googleMapsAPIKey;
            script.async = true;
            script.defer = true;
...
MapModalComponent.propDecorators = {
    mapElementRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['map', { static: true },] }],
    ...
    closeButtonText: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CnicMaskDirective", function() { return CnicMaskDirective; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let CnicMaskDirective = class CnicMaskDirective {
...
CnicMaskDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControl"] }
];
CnicMaskDirective.propDecorators = {
    onEvent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['input', ['$event'],] }]
};
CnicMaskDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MasksModule", function() { return MasksModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _cnic_mask_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cnic-mask.directive */ "./src/app/shared/masks/cnic-mask.directive.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _phone_mask_directive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./phone-mask.directive */ "./src/app/shared/masks/phone-mask.directive.ts");
...
let MasksModule = class MasksModule {
};
MasksModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
PhoneMaskDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
...
let ImagePickerComponent = class ImagePickerComponent {
    constructor(platform, patientService, dms) {
...
ImagePickerComponent.propDecorators = {
    ...
    imagePick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"] }]
};
        ...
        this.modalCtrl.create({ component: _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_6__["MapModalComponent"] }).then(modalEl => {
            modalEl.onDidDismiss().then(modalData => {
                ...
                this.getAddress(modalData.data.lat, modalData.data.lng)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(address => {
                    console.log(pickedLocation.address = address);
                    this.getAddress = address;
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(this.getMapImage(pickedLocation.lat, pickedLocation.lng, 15));
                }))
...
LocationPickerComponent.propDecorators = {
    locationPick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"] }]
};
...
//# sourceMappingURL=default~doctor-doctor-signup-doctor-signup-module~patient-patient-signup-patient-signup-module-es2015.js.map